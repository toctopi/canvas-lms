define('jst/util/select/options', ["compiled/handlebars_helpers"], function (Handlebars) {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
  templates['util/select/options'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program1(depth0,data) {
  ...
  return templates['util/select/options'];
});
