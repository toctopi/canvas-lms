(function() {
  ...
  define(['jquery', 'i18n!calendar', 'compiled/util/Popover', 'compiled/calendar/CommonEvent', 'compiled/calendar/EditEventDetailsDialog', 'jst/calendar/eventDetails', 'jst/calendar/deleteItem', 'jst/calendar/reservationOverLimitDialog', 'compiled/calendar/MessageParticipantsDialog', 'compiled/fn/preventDefault', 'underscore', 'jquery.ajaxJSON', 'jquery.instructure_misc_helpers', 'jquery.instructure_misc_plugins', 'vendor/jquery.ba-tinypubsub'], function($, I18n, Popover, CommonEvent, EditEventDetailsDialog, eventDetailsTemplate, deleteItemTemplate, reservationOverLimitDialog, MessageParticipantsDialog, preventDefault, _) {
    ...
    return ShowEventDetailsDialog = (function() {
      ...
      ShowEventDetailsDialog.name = 'ShowEventDetailsDialog';
      ...
      ShowEventDetailsDialog.prototype.show = function(jsEvent) {
        ...
        params.showEventLink = params.can_edit && params.fullDetailsURL();
        ...
        return this.popover.el.find('.message_students').click(preventDefault(function() {
