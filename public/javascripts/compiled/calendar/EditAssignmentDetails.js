(function() {
  ...
  define(['jquery', 'compiled/calendar/commonEventFactory', 'jst/calendar/editAssignment', 'jst/calendar/genericSelect', 'jquery.instructure_date_and_time', 'jquery.instructure_forms', 'jquery.instructure_misc_helpers'], function($, commonEventFactory, editAssignmentTemplate, genericSelectTemplate) {
    var EditAssignmentDetails;
    return EditAssignmentDetails = (function() {

      EditAssignmentDetails.name = 'EditAssignmentDetails';
      ...
      function EditAssignmentDetails(selector, event, contextChangeCB, closeCB) {
        ...
        this.form = $(editAssignmentTemplate({
      ...
      EditAssignmentDetails.prototype.contextChange = function(jsEvent, propagate) {
        var assignmentGroupsSelectInfo, context, moreOptionsUrl;
        ...
        this.form.find(".assignment_group_select").html(genericSelectTemplate(assignmentGroupsSelectInfo));
      ...
      EditAssignmentDetails.prototype.formSubmit = function(jsEvent) {
        var dueAt, dueAtString, newEvent, objectData, params;
        jsEvent.preventDefault();
        dueAtString = this.form.getFormData()['assignment[due_at]'];
        if (dueAtString === '') {
          dueAt = null;
        } else {
