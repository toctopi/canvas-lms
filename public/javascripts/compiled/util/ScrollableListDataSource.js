    ...
    return (function() {
      ...
      _Class.prototype.positionOrReload = function(item, currPos) {
        ...
        if ((pos != null) && !this.deferredPositionChecks) {
          ...
          if (this.deferredPositionChecks == null) {
      ...
      _Class.prototype.positionFor = function(item, currPos) {
        var goesBefore, i, unmoved, _i, _ref,
          _this = this;
        ...
        if (this.items.length === this.itemIds.length || this.itemIds.length === 0) {
      ...
      _Class.prototype.fetchedPage = function(page, itemIds, items) {
        var numToReplace, offset, _base, _ref, _ref1;
        offset = page * this.perPage;
        ...
        if ((_base = this.items)[offset] == null) {
          _base[offset] = null;
        }
        (_ref1 = this.items).splice.apply(_ref1, [offset, numToReplace].concat(__slice.call(items)));
