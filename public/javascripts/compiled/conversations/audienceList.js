(function() {
  ...
  define(['i18n!conversations', 'underscore', 'str/htmlEscape', 'compiled/conversations/listWithOthers', 'jquery.instructure_misc_helpers'], function(I18n, _, h, listWithOthers) {
    var format;
