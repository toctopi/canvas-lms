(function() {
  ...
  define(['jquery', 'jst/AssignmentDetailsDialog', 'jqueryui/dialog'], function($, assignmentDetailsDialogTemplate) {
    var AssignmentDetailsDialog;
    return AssignmentDetailsDialog = (function() {

      AssignmentDetailsDialog.name = 'AssignmentDetailsDialog';
