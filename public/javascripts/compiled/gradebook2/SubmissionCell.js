(function() {
  ...
  define(['compiled/gradebook2/GRADEBOOK_TRANSLATIONS', 'jquery', 'jquery.ajaxJSON'], function(GRADEBOOK_TRANSLATIONS, $) {
    var SubmissionCell;
    SubmissionCell = (function() {

      SubmissionCell.name = 'SubmissionCell';
      ...
      SubmissionCell.prototype.cellWrapper = function(innerContents, options) {
        var opts, specialClasses, tooltipText, _ref;
        if (options == null) {
          options = {};
        }
        opts = $.extend({}, {
    ...
    SubmissionCell.letter_grade = (function(_super) {
      ...
      letter_grade.name = 'letter_grade';
